...
declare module '$env/static/private' {
	...
	export const GSHEET_SHEET_ID: string;
	export const GSHEET_ID: string;
	export const GSHEET_SHEET: string;
	export const GOOGLE_CREDENTIALS_B64: string;
	...
	export const EFC_37732_1592913036: string;
